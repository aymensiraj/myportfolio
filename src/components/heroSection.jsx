...
const Hero = () => {
  ...
  return (
    <section id="home" className="h-screen flex flex-col items-center justify-center lg:pt-72">
      ...
      <div className="text-center">
        ...
        <MotionDiv
          ...
          initial="hidden"
          animate="visible"
          className="text-lg lg:text-6xl  md:text-2xl text-indigo-400 font-mono mt-4 tracking-widest uppercase overflow-hidden flex justify-center"
        >
      ...
      <div className="text-center">
        <MotionH1 
          ...
          className=" text-6xl md:text-8xl  lg:text-[200px] font-black text-white tracking-tight"
        >
          AYMEN
        </MotionH1>
        <MotionH1 
      ...
      <MotionDiv
        ...
        className=" relative mt-3 w-48 h-48 md:w-60 md:h-60 mb-10 group z-30 lg:bottom-80"
      >
